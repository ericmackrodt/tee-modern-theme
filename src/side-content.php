<div class="side-content">
  ...
  <window window-id="twitter" v-bind:desktop="sidePanelDesk" title="Twitter" icon="/assets/folder-icon.png">
  ...
  <window window-id="soundcloud" v-bind:desktop="sidePanelDesk" title="SoundCloud" icon="/assets/folder-icon.png">
  ...
  <window window-id="compatibility" v-bind:desktop="sidePanelDesk" title="Compatibility" icon="/assets/folder-icon.png">
    <div id="compatibility-content">
      ...
      <div class="compatibility-row">
        <a href="/windows3x/essentialsoftware#internetexplorer501">
          <img src="/assets/200.gif" width="88" height="31" alt="Compatible with IE" />
        </a>
        <a href="/windows3x/essentialsoftware#netscapecommunicator407">
          <img src="/assets/netscap4.gif" alt="Compatible with Netscape" />
        </a>
      </div>
    </div>
  </window>
